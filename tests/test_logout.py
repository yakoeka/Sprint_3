...
def test_logout_from_profile_page(driver):
    ...
    driver.find_element(By.LINK_TEXT, "Личный Кабинет").click()
    WebDriverWait(driver, 3).until(expected_conditions.element_to_be_clickable((By.XPATH, profile_page.logOutBtn)))
    driver.find_element(By.XPATH, profile_page.logOutBtn).click()
